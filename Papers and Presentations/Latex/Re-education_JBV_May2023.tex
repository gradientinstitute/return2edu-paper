...
data differ greatly from the original individual treatment effects.\todo{I think more  explanation may be needed here? It seems like something has been lost by moving the PI description to the appendix.}
...
Hierarchical Logistic Model	 & 5441 & 0.0135 & [0.0000, 0.0295]  \\
Approximate Gaussian Process  & 5441 & 0.0127 & [-0.0008, 0.0272] \\
\bottomrule
\end{tabular}
\par\medskip
...
\todo{I have to fill this out. Is this okay, and if so, is this placement okay?}
