...
def scrub_output_pre_save(model, **kwargs):
    ...
    print("Scrubbing notebook output")
...
#  Choices: any of ['sha224', 'md5', 'sha256', 'sha512', 'sha3_256', 'sha3_384', 'blake2b', 'sha3_224', 'blake2s', 'sha384', 'sha3_512', 'sha1']
#  Default: 'sha256'
